	...
	long privilegeId = -1;
	 	...
	 	<table class="bordered fitToParent view_table" >
			...
			<tbody>
				...
				<tr class="itemProperty">
					...
					<td class="tdBody"><input type="hidden" name="mea_class_no" value="${article.mea_class_no }" readonly="readonly"/>${article.mea_class_no }</td>
				...
				<tr class="itemProperty createTextarea createTextarea">
 	...
 	<script>
 		...
 		function deleteHistory(historyId){
 			...
 			var method="POST";
 			var url="itemCategory.do?action=deleteItemHistory&articleId="+historyId+"&privilegeId="+<%=privilegeId%>;
 			var isAsync=true;

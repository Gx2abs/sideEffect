 ...
 <link rel="stylesheet" type="text/css" href="view/style/css/properties/item.css">
	...
	long privilegeId = -1;
 	...
 	<form name="productCreateForm1" method="POST" action="safetyItem.do">
	 	...
	 	<table class="bordered fitToParent view_table" id="insertTable">
			...
			<tbody>
				<tr class="itemProperty">
					...
					<td class="tdBody">
					<input type="hidden" name="company_id" /><input type="text" name="company_num" /><input type="text" name="company_name" /><img src="view/style/images/bt_search.jpg" class="hover1" alt="검색" onclick="pop1();" />
					</td>
				</tr>
				<tr class="itemProperty">
					<th class="tdHead" colspan="2" >품목정보</th>
					<td class="tdBody"><input type="hidden" name="item_id" /><input type="text" name="mea_class_no" /><input type="text" name="item_class_kor_name" /><img src="view/style/images/bt_search.jpg" class="hover1" alt="검색" onclick="pop2();" /></td>
				</tr>
				<tr class="itemProperty">
				...
				<tr class="itemProperty">
					...
					형명 --><input type="text" name=name[] ><img src="view/style/images/btn_tab02.jpg" class="hover1" alt="추가" id="addItemType" onclick="fnc_addItemType()" />
					<ul id="itemUl"><li class="item_typeLi"></li></ul>
	 	...
	 	<div class="btnType3">
	 		<img src="view/style/images/btn_ok.jpg" id="submit1" alt="확인" class="buttonised" onclick="chkNameCreate();"/>

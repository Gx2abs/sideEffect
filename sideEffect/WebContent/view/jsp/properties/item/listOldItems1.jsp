 		...
 		<c:choose>
		 	<c:when test="${!empty requestScope.list }">
		 		<c:forEach var="item" items="${requestScope.list }">
				 	<tr class="listover" onMouseOver="this.style.backgroundColor='#F6F6F6'" onMouseOut="this.style.backgroundColor='#FFFFFF'"onclick="send('${item.compositeKey.mea_class_no}', ${item.compositeKey.grade },'${item.class_kor_name }');" >
				 		<td colspan="2">

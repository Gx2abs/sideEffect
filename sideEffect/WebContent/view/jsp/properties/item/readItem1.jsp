	...
	long privilegeId = -1;
 	...
 	<form name="itemCreateForm1" method="post" action="properties.do">
	 	...
	 	<div class="btnType3">
		 	...
		 	<img src="view/style/images/btn_del.jpg" name="delete" alt="delete" class="buttonised" onclick="del('${article.compositeKey.mea_class_no}',${article.compositeKey.grade });"/>
		 	<%} %>
...
function del(mcn, grade){
  		if(confirm("삭제하시겠습니까?")){
  			location.href="properties.do?action=deleteItem&mea_class_no="+mcn+"&grade="+grade+"&privilegeId="+<%=privilegeId%>;	
  		}

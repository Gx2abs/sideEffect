<%@ page language="java" pageEncoding="UTF-8"%>
 ...
 <link rel="stylesheet" type="text/css" href="view/style/css/properties/item.css">
	...
	long privilegeId = -1;
 	...
 	<input type="hidden" name="action" value="createReportType"/>
	 	...
	 	<table class="bordered fitToParent view_table" >
			...
			<tbody>
				...
				<tr class="itemProperty">
					...
					<td class="tdBody" ><input type="hidden" name="history_manager" value="${sessionScope.user.accountName}" />${sessionScope.user.accountName}</td>
				</tr>
				<tr class="itemProperty createTextarea">
					<th class="tdHead" >사유</th>
					<td class="tdBody" ><textarea name="history_description"></textarea></td>
				</tr>
				<tr class="itemProperty">

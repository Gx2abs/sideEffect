...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
 ...
 <link rel="stylesheet" type="text/css" href="view/style/css/properties/item.css">
 	<div>
	 	<form method="POST" name="publicationTypeFrom1" action="publication.do" >
			<input type="hidden" value="createPublicationType" name="action"/>
	 		<table class="bordered fitToParent view_table" >
			<thead>
				<tr>
					<th colspan="5">구분 등록</th>
				</tr>
			</thead>
			<tbody>
 ...
 <script type="text/javascript" >
 	...
 	function createPublicationType(){
 		...
 		var method = "get";
 		var url = "publication.do?action=createPublicationType&prop1="+encodeURIComponent(prop1);
 		var isAsync = true;

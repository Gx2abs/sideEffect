 ...
 <link rel="stylesheet" type="text/css" href="view/style/css/spectrum.css">
	...
	long privilegeId = -1;
 	...
 	<form name="itemCategoryGroupBackCreateForm1" method="POST" action="risk.category.do">
 		<input type="hidden" name="action" value="updateItemCategoryGroupBack"/>
 		<input type="hidden" name="articleId" value="${backup.id }"/>
 		<input type="hidden" name="groupId" value="${backup.group_id }"/>

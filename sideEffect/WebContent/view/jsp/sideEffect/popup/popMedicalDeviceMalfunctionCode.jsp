...
<%@ page import="properties.SimpleMedicalDeviceMalfunctionCode" %>
...
<%
	...
	List medicalDMCList = (List)request.getAttribute("medicalDMCList");
	
	System.out.println("medicalDMCListSize======" + medicalDMCList.size());
		
	try {	
		
		DataSet ds = new DataSet("ds_medicalDMC");
		  ...
		  for(int i=0; i < medicalDMCList.size(); i++) {
			  SimpleMedicalDeviceMalfunctionCode bean = (SimpleMedicalDeviceMalfunctionCode) medicalDMCList.get(i);

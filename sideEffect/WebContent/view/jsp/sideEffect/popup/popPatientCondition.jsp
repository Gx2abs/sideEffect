...
<%@ page import="properties.SimplePatientCondition" %>
...
<%
	...
	try {	
		...
		DataSet ds = new DataSet("ds_patientCondition");
		  ds.addColumn("ID" 			  			,DataTypes.INT		,(short)10   );
		  ds.addColumn("FDA_CODE"			 		,DataTypes.STRING	,(short)255  );
		  ds.addColumn("FDA_SOURCE_PT_KOR" 			,DataTypes.STRING	,(short)255  );
		  ds.addColumn("FDA_SOURCE_DEFINITION"  	,DataTypes.STRING	,(short)400  );
		  ds.addColumn("FDA_SOURCE_DEFINITION_KOR"  ,DataTypes.STRING	,(short)255  );
		  ds.addColumn("NCIT_DEFINITION"   			,DataTypes.STRING	,(short)800  );
		  ds.addColumn("NCIT_DEFINITION_KOR"   		,DataTypes.STRING	,(short)800  );
		  ds.addColumn("PARENT_ID" 					,DataTypes.INT  	,(short)10 	 );
		  ds.addColumn("NAME"   					,DataTypes.STRING	,(short)50   );
		  ds.addColumn("NCI_CODE"    				,DataTypes.STRING   ,(short)20   );
		  ds.addColumn("DEPTH_LEVEL"    			,DataTypes.INT   	,(short)10   );
		  ds.addColumn("CHECK_YN"    				,DataTypes.STRING   ,(short)10   );
		  
		  for(int i=0; i < patientList.size(); i++) {
			  SimplePatientCondition bean = (SimplePatientCondition)patientList.get(i);

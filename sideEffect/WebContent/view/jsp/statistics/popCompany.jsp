...
<%@ page import="safety.renewal.company.Company1" %>
	...
	try {	
		...
		DataSet ds = new DataSet("ds_codeList");
		  ...
		  for(int i=0; i <codeList.size(); i++) {
			  Company1 bean = (Company1)codeList.get(i);
			  
			int row = ds.newRow();
			ds.set(row ,"ID"    					,(bean.getMeddev_entp_seq())   );
			ds.set(row ,"NAME"    					,Function.nullChk(bean.getEntp_name(),"") );

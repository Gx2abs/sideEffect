	...
	try {	
		...
		DataSet ds = new DataSet("ds_codeList");
		  ...
		  for(int i=0; i <codeList.size(); i++) {
			  SimpleItem1 bean = (SimpleItem1)codeList.get(i);
			  
			int row = ds.newRow();
			ds.set(row ,"ID"    					,(bean.getId())   );
			ds.set(row ,"NAME"    					,Function.nullChk(bean.getMea_item().getClass_kor_name(),"") +" / " +Function.nullChk(bean.getCobFlagType().getPropertyValue(),"") + " " +bean.getMeddev_item_no() );

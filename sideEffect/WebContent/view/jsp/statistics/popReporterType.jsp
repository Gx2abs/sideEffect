...
<%@ page import="properties.ReporterType" %>
...
<%
	...
	String sTest="조회실패";
	// 조회조건에 보고자유형이 추가되면서 dataSet 명칭을 java에서 지정함
	String dataSet = request.getAttribute("dataSet").toString();
	...
	try {	
		...
		DataSet ds = new DataSet(dataSet);
		  ...
		  for(int i=0; i <codeList.size(); i++) {
			  ReporterType bean = (ReporterType)codeList.get(i);

...
<%@ page import="sideeffect.SimpleSideeffectCause" %>
	...
	try {	
		...
		DataSet ds = new DataSet("ds_codeList");
		  ...
		  for(int i=0; i <codeList.size(); i++) {
			  SimpleSideeffectCause bean = (SimpleSideeffectCause)codeList.get(i);
			  
			int row = ds.newRow();
			ds.set(row ,"ID"    					,(bean.getId())   );
			ds.set(row ,"NAME"    					,Function.nullChk(bean.getProperty_value(),"") );

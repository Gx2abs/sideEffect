...
<%@ page import="safety.renewal.sgi.item.SimpleItemCodeType1" %>
...
<%
	...
	try {	
		...
		DataSet ds = new DataSet("ds_productCode");
		...
		ds.set(row ,"DEPTH_LEVEL"  				,1);
		  ...
		  for(int i=0; i <codeList.size(); i++) {
			  SimpleItemCodeType1 bean = (SimpleItemCodeType1)codeList.get(i);

...
<%@ page import="safety.SimpleSafetyReport" %>
...
<%
	...
	List codeList = (List)request.getAttribute("ItemSafetyList");
	String totalCnt =request.getAttribute("ItemSafetyCnt").toString();
		...
		DataSet ds = new DataSet(ds_name);
		 ds.addColumn("ITEM_CATEGORY_ID" 		,DataTypes.INT		,(short)10   );
		  ...
		  for(int i=0; i <codeList.size(); i++) {
			...
			SimpleSafetyReport bean = (SimpleSafetyReport)codeList.get(i);
			row = ds.newRow();

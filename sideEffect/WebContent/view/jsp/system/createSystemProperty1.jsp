<%@ page language="java" pageEncoding="UTF-8"%>
 ...
 <link rel="stylesheet" type="text/css" href="view/style/css/properties/item.css">
 	...
 	<form name="itemCreateForm1" method="post" action="properties.do">
 		...
 		<input type="text" name="action" value="createItem"/>
	 	<table class="bordered fitToParent view_table" >
			...
			<tbody>
					...
					<td colspan="3">
							<c:choose>
								<c:when test="${!empty requestScope.level1List  }">
									...
									<select class="hidden" name="parentItemGrade" id = "parentItemGrade">
									<c:forEach var="lv1Item" items="${level1List }">
										<option value="${lv1Item.grade }">${lv1Item.grade }</option>
									</c:forEach>
									</select>
				...
				<tr class="itemProperty">
					...
					<td class="tdBody"><input type="text" name="mea_class_no_code" /></td>
				...
				<tr class="itemProperty">
					...
					<td class="tdBody" colspan="3"><input type="text" name="itemNameKr" /></td>
				</tr>
				<tr class="itemProperty">
					<th class="tdHead" colspan="2">품목영문명</th>
					<td class="tdBody" colspan="3"><input type="text" name="itemNameEn" /></td>
				</tr>
				<tr class="itemProperty">

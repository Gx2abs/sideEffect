...
public class Function
{
    ...
    public static String fnAdminMsg(String url, String AdminYn, String PageMode)
    {
        ...
        if(AdminYn.equals("N"))
        {
            ...
            rtnStr = (new StringBuilder(String.valueOf(rtnStr))).append("  alert('\uFFFD\u03B1\uFFFD\uFFFD\uFFFD \uFFFD\uFFFD\uFFFD\uFFFD\uFFFD\uFFFD \uFFFD\u04BD\u01F5\u01FE\uFFFD\u0173\uFFFD \uFFFD\uFFFD\uFFFD\uFFFD \uFFFD\uFFFD\uFFFD\uFFFD\uFFFD\uFFFD \uFFFD\uFFFD\uFFFD\uFFFD\u03F4\uFFFD.');").toString();
    ...
    public static String fnLoginMsg(String url, String LoginYn, String pgMode)
    {
        ...
        {
            rtnStr = (new StringBuilder(String.valueOf(rtnStr))).append("<script language='javascript'>").toString();
            rtnStr = (new StringBuilder(String.valueOf(rtnStr))).append("  alert('\uFFFD\360\uFFFD\uFFFD\uFFFD \uFFFD\uFFFD\uFFFD\uFFFD\uFFFD\uFFFD \uFFFD\u03B1\u05FE\u01BF\uFFFD \uFFFD\u01FE\uFFFD\uFFFD\uFFFD\u03F4\uFFFD.');").toString();
    ...
    public static void writeLog(String path, String flag, String pgm, String msg) {
		...
		String upPath = upPath3 + File.separator;
		...
		try {
			while(true) {
				...
				if(log.length() > 5*1024*1024) {
					File old_log = new File(filePath +".old");
					old_log.delete();
    ...
    public static String convertDate(String str)
    {
        ...
        {
            result.append(str.substring(0, 4)).append("\uFFFD\uFFFD ").append(str.substring(4, 6)).append("\uFFFD\uFFFD ").append(str.substring(6)).append("\uFFFD\uFFFD");
            return result.toString();
        } else
        {
            return nullChk(str);
    ...
    public static String fnLogAction(String code)
    {
        String rtnStr = "";
        if(code.equals("C"))
            rtnStr = "<font color=\"forestgreen\">\uFFFD\uFFFD\uFFFD\uFFFD</font>";
        else
        if(code.equals("L"))
            rtnStr = "<font color=\"#8c008c\">\uFFFD\uFFFD\u0238</font>";
        else
        if(code.equals("I"))
            rtnStr = "<font color=\"blue\">\uFFFD\uFFFD\uFFFD</font>";
        else
        if(code.equals("U"))
            rtnStr = "<font color=\"darkorange\">\uFFFD\uFFFD\uFFFD\uFFFD</font>";
        else
        if(code.equals("D"))
            rtnStr = "<font color=\"red\">\uFFFD\uFFFD\uFFFD\uFFFD</font>";
        else
        if(code.equals("F"))
            rtnStr = "<font color=\"#666600\">\uFFFD\uFFFD\uFFFD\uFFFD</font>";
        else
            rtnStr = "<font color=\"black\">\uFFFD\uFFFD\u0178</font>";
        return rtnStr;
    }
    ...
    public static String fnAdmGrade(String grade)
    {
        String rtnStr = "";
        if(grade.equals("S"))
            rtnStr = "<font color=\"#8c008c\">\uFFFD\375\uFFFD\uFFFD\u06F0\uFFFD\uFFFD\uFFFD</font>";
        else
        if(grade.equals("A"))
            rtnStr = "<font color=\"forestgreen\">\uFFFD\uFFFD\uFFFD\uFFFD</font>";
        else
    ...
    public static String fnHourSelected(String code)
    {
        ...
        rtnStr.append((new StringBuilder("<option value=\"00\" ")).append(IsSelected(code, "00")).append(">0\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"01\" ")).append(IsSelected(code, "01")).append(">1\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"02\" ")).append(IsSelected(code, "02")).append(">2\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"03\" ")).append(IsSelected(code, "03")).append(">3\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"04\" ")).append(IsSelected(code, "04")).append(">4\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"05\" ")).append(IsSelected(code, "05")).append(">5\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"06\" ")).append(IsSelected(code, "06")).append(">6\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"07\" ")).append(IsSelected(code, "07")).append(">7\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"08\" ")).append(IsSelected(code, "08")).append(">8\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"09\" ")).append(IsSelected(code, "09")).append(">9\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"10\" ")).append(IsSelected(code, "10")).append(">10\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"11\" ")).append(IsSelected(code, "11")).append(">11\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"12\" ")).append(IsSelected(code, "12")).append(">12\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"13\" ")).append(IsSelected(code, "13")).append(">13\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"14\" ")).append(IsSelected(code, "14")).append(">14\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"15\" ")).append(IsSelected(code, "15")).append(">15\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"16\" ")).append(IsSelected(code, "16")).append(">16\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"17\" ")).append(IsSelected(code, "17")).append(">17\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"18\" ")).append(IsSelected(code, "18")).append(">18\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"19\" ")).append(IsSelected(code, "19")).append(">19\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"20\" ")).append(IsSelected(code, "20")).append(">20\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"21\" ")).append(IsSelected(code, "21")).append(">21\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"22\" ")).append(IsSelected(code, "22")).append(">22\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"23\" ")).append(IsSelected(code, "23")).append(">23\uFFFD\uFFFD</option>").toString());
    ...
    public static String fnMinuteSelected(String code)
    {
        StringBuffer rtnStr = null;
        rtnStr = new StringBuffer();
        rtnStr.append((new StringBuilder("<option value=\"00\" ")).append(IsSelected(code, "00")).append(">00\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"05\" ")).append(IsSelected(code, "05")).append(">05\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"10\" ")).append(IsSelected(code, "10")).append(">10\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"15\" ")).append(IsSelected(code, "15")).append(">15\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"20\" ")).append(IsSelected(code, "20")).append(">20\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"25\" ")).append(IsSelected(code, "25")).append(">25\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"30\" ")).append(IsSelected(code, "30")).append(">30\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"35\" ")).append(IsSelected(code, "35")).append(">35\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"40\" ")).append(IsSelected(code, "40")).append(">40\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"45\" ")).append(IsSelected(code, "45")).append(">45\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"50\" ")).append(IsSelected(code, "50")).append(">50\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"55\" ")).append(IsSelected(code, "55")).append(">55\uFFFD\uFFFD</option>").toString());
        return rtnStr.toString();
    }
    ...
    public static String fnView(String code)
    {
        String rtnStr = "";
        if(code.equals("Y"))
            rtnStr = "<font color=\"black\">\uFFFD\uFFFD\uFFFD\uFFFD</font>";
        else
        if(code.equals("N"))
            rtnStr = "<font color=\"red\">\uFFFD\u023A\uFFFD\uFFFD\uFFFD</font>";
        else
            rtnStr = "";
        return rtnStr;
    }
    ...
    public static String fnViewSelected(String code)
    {
        StringBuffer rtnStr = null;
        rtnStr = new StringBuffer();
        rtnStr.append((new StringBuilder("<option value=\"Y\" ")).append(IsSelected(code, "Y")).append(">\uFFFD\uFFFD\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"N\" ")).append(IsSelected(code, "N")).append(">\uFFFD\u023A\uFFFD\uFFFD\uFFFD</option>").toString());
        return rtnStr.toString();
    }
    ...
    public static String fnViewRadio(String code)
    {
        StringBuffer rtnStr = null;
        rtnStr = new StringBuffer();
        rtnStr.append((new StringBuilder("<input type=\"radio\" name=\"car_view\" value=\"Y\" style=\"border:0\" ")).append(IsChecked(code, "Y")).append(">\uFFFD\uFFFD\uFFFD\uFFFD&nbsp;&nbsp;").toString());
        rtnStr.append((new StringBuilder("<input type=\"radio\" name=\"car_view\" value=\"N\" style=\"border:0\" ")).append(IsChecked(code, "N")).append(">\uFFFD\u023A\uFFFD\uFFFD\uFFFD").toString());
        return rtnStr.toString();
    }
    ...
    public static String fnState(String code)
    {
        String rtnStr = "";
        if(code.equals("0"))
            rtnStr = "<font color=\"blue\">\uFFFD\uFFFD\373</font>";
        else
        if(code.equals("1"))
            rtnStr = "<font color=\"forestgreen\">\uFFFD\uFFFD\uFFFD\uFFFD</font>";
        else
        if(code.equals("2"))
            rtnStr = "<font color=\"black\">\uFFFD\u07F1\uFFFD</font>";
        else
        if(code.equals("3"))
            rtnStr = "<font color=\"purple\">\uFFFD\u0777\uFFFD</font>";
        else
            rtnStr = "";
        return rtnStr;
    }
    ...
    public static String fnStateSelected(String code)
    {
        StringBuffer rtnStr = null;
        rtnStr = new StringBuffer();
        rtnStr.append((new StringBuilder("<option value=\"0\" ")).append(IsSelected(code, "0")).append(">\uFFFD\uFFFD\373</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"1\" ")).append(IsSelected(code, "1")).append(">\uFFFD\uFFFD\uFFFD\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"2\" ")).append(IsSelected(code, "2")).append(">\uFFFD\u07F1\uFFFD</option>").toString());
        rtnStr.append((new StringBuilder("<option value=\"3\" ")).append(IsSelected(code, "3")).append(">\uFFFD\u0777\uFFFD</option>").toString());
        return rtnStr.toString();
    }
    ...
    public static String fnStateRadio(String code)
    {
        StringBuffer rtnStr = null;
        rtnStr = new StringBuffer();
        rtnStr.append((new StringBuilder("<input type=\"radio\" name=\"car_state\" value=\"0\" style=\"border:0\" ")).append(IsChecked(code, "0")).append(">\uFFFD\uFFFD\373&nbsp;&nbsp;").toString());
        rtnStr.append((new StringBuilder("<input type=\"radio\" name=\"car_state\" value=\"1\" style=\"border:0\" ")).append(IsChecked(code, "1")).append(">\uFFFD\uFFFD\uFFFD\uFFFD&nbsp;&nbsp;").toString());
        rtnStr.append((new StringBuilder("<input type=\"radio\" name=\"car_state\" value=\"2\" style=\"border:0\" ")).append(IsChecked(code, "2")).append(">\uFFFD\u07F1\uFFFD&nbsp;&nbsp;").toString());
        rtnStr.append((new StringBuilder("<input type=\"radio\" name=\"car_state\" value=\"3\" style=\"border:0\" ")).append(IsChecked(code, "3")).append(">\uFFFD\u0777\uFFFD").toString());
        return rtnStr.toString();
    }
    ...
    public static void log( String pgm, String msg) {
		...
		String timeZone = cal.getTimeZone().getDisplayName(true,TimeZone.SHORT);
		if(timeZone.equals("GMT")) {
		   cal.add(Calendar.HOUR_OF_DAY,9);  // �ѱ��ð����� ����(GMT+9)
	    }
		String path="";
		String today = sdf.format(cal.getTime());
		PrintStream ps = null;
		...
		String upPath2 = upPath1 + File.separator + Function.fnToday(4);
		String upPath3 = upPath2 + File.separator + Function.fnToday(6).substring(4,6);
		Function.fnFolderChk(upPath1); //��Ű���� �����
		Function.fnFolderChk(upPath2); //�⵵�� �����
		Function.fnFolderChk(upPath3); //�� �����
		String upPath = upPath3 + File.separator; //���� ���ε� ���
		String filePath = upPath + "log_"+ Function.fnToday(8);
		//System.out.println("upPath="+upPath);
		...
		try {
			while(true) {
				log = new File(filePath + ".log");
				log.createNewFile();
				if(log.length() > 5*1024*1024) { //���� �α����� ũ�Ⱑ 5M�� ������
					File old_log = new File(filePath +".old"); // ���� �̹� old�� �ִٸ� �����.
					old_log.delete();
					log.renameTo(new File(filePath +".old"));
				} else {
					break;
        ...
        try
        {
            if(str != null && str.length > 0)
            {
                ...
                for(int i = 0; i < j; i++)
                {
                    ...
                    try
                    {
                        System.out.println((new StringBuilder("Function.nullChk(String[] str). each string - s : ")).append(s).toString());
    ...
    public static String SITE_NAME = "TEST\uFFFD\375\uFFFD\uFFFD\uFFFD";
    ...
    public static String UPLOAD_FileExtOK = "hwp,gul,doc,xls,ppt,zip,jpg,gif,swf,txt,bmp,swf,txt,xlsx,pptx,docx,pdf";
    public static String UPLOAD_ImgExtOK = "jpg,gif,bmp";

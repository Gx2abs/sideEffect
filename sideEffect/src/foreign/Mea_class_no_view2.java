...
// Source File Name:   Mea_class_no_view2.java
...
public class Mea_class_no_view2
    implements Interface_mea_class_no, IDValuePair
{

    public Mea_class_no_view2()
    {
    }

    public int getCode_age_id()
    {
        return code_age_id;
    }

    public void setCode_age_id(int code_age_id)
    {
        this.code_age_id = code_age_id;
    }
    ...
    public void setMeaClassNoLevel(SimpleMeaClassNoLevel meaClassNoLevel)
    {

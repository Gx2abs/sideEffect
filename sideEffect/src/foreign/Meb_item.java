...
// Source File Name:   Meb_item.java
...
//            Interface_meb_item, Mea_class_no

public class Meb_item
    implements Interface_meb_item
{
    ...
    public List getMebLotNo()
    {
        return mebLotNo;
    }

    public void setMebLotNo(List mebLotNo)
    {
        this.mebLotNo = mebLotNo;
    }

    public List getMebTypeInfo()
    {
        return mebTypeInfo;
    }

    public void setMebTypeInfo(List mebTypeInfo)
    {
        this.mebTypeInfo = mebTypeInfo;
    }
    ...
    public void setRemark(String remarkt)
    {
        remark = remarkt;
    }
    ...
    private List mebTypeInfo;
    private List mebLotNo;
}

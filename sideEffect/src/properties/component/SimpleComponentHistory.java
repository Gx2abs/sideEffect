...
// Source File Name:   SimpleComponentHistory.java
...
public class SimpleComponentHistory extends AbstractIDValuePair
    implements ComponentHistory
{

    public SimpleComponentHistory()
    {
    }

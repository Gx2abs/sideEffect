...
// Source File Name:   SimpleComponentServiceProvider.java
...
//            ComponentServiceProvider, SimpleComponentHistory, ComponentHistory

public class SimpleComponentServiceProvider
    implements ComponentServiceProvider
{

    public SimpleComponentServiceProvider()
    {
    }

    public ComponentHistory buildOrEmpty(HttpServletRequest request)
    {
        ...
        try
        {
            if(validate(request))
            {
                ...
                history = new SimpleComponentHistory();

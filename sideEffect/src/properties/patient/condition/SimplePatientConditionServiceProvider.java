...
// Source File Name:   SimplePatientConditionServiceProvider.java
...
//            PatientConditionServiceProvider, SimplePatientConditionHistory, PatientConditionHistory

public class SimplePatientConditionServiceProvider
    implements PatientConditionServiceProvider
{

    public SimplePatientConditionServiceProvider()
    {
    }

    public PatientConditionHistory buildOrEmpty(HttpServletRequest request)
    {
        PatientConditionHistory history = null;
        try
        {
            if(validate(request))
            {
                ...
                history = new SimplePatientConditionHistory();
    ...
    public boolean validate(HttpServletRequest request)
    {
        ...
        System.out.println((new StringBuilder("SimplePatientConditionServiceProvicer.validate : ")).append(result).toString());
        return result;
    }
}

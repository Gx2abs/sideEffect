...
// Source File Name:   SimpleSafetyReport.java
...
public class SimpleSafetyReport
    implements SafetyReport
{

    public SimpleSafetyReport()
    {
    }
    ...
    {
        this.follow_up_action = follow_up_action.intValue();
    }
    ...
    {
        return country_reported_in;
    }

    public void setCountry_reported_in(Integer country_reported_in)
    {
        this.country_reported_in = country_reported_in;
    }
    ...
    private Integer country_reported_in;

...
// Source File Name:   SimpleItemCategory.java
...
//            ItemCategory, SimpleItemCategoryLevel, SimpleItemCategoryGrade, SimpleItemCategoryCodeType, 
//            SimpleItemCategoryTraceability
    ...
    implements ItemCategory, IDValuePair
{
    ...
    public SimpleItemCategory getParent()
    {
        return parent;
    }

    public void setParent(SimpleItemCategory parent)
    {
        this.parent = parent;
    }
    ...
    {
        return juncItemCategoryGroup;
    }

    public void setJuncItemCategoryGroup(SimpleJuncItemCategoryGroup juncItemCategoryGroup)
    {
        this.juncItemCategoryGroup = juncItemCategoryGroup;
    }
    ...
    private SimpleJuncItemCategoryGroup juncItemCategoryGroup;
    ...
    private SimpleItemCategory parent;
}

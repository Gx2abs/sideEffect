...
// Source File Name:   SimpleTmpItemCategory.java
...
public class SimpleTmpItemCategory
    implements ItemCategory, IDValuePair
{

    public SimpleTmpItemCategory()
    {
    ...
    public SimpleTmpItemCategory getParent()
    {
        return parent;
    }

    public void setParent(SimpleTmpItemCategory parent)
    {
        this.parent = parent;
    }
    ...
    private SimpleTmpItemCategory parent;
}

...
// Source File Name:   SimpleComponentInsert.java

package system.batch;

import java.util.*;
import properties.ComponentCode;
import properties.SimpleIsInUse;

public class SimpleComponentInsert
    implements ComponentCode
{

    public SimpleComponentInsert()
    {
        componentHistory = new HashSet();
    }
    ...
    public Set getComponentHistory()
    {
        return componentHistory;
    }

    public void setComponentHistory(Set componentHistory)
    {
